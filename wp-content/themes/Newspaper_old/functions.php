...
require_once __DIR__ . '/CMB2/manager-banner-function.php';

// Creates Movie Reviews Custom Post Type
function manager_banner_init() {
    $args = array(
        'label' => 'Manager Banner',
        'public' => true,
        'show_ui' => true,
        'capability_type' => 'post',
        'hierarchical' => false,
        'rewrite' => array('slug' => 'manager-banner'),
        'query_var' => true,
    ...
    register_post_type( 'manager-banner', $args );
}
add_action( 'init', 'manager_banner_init' );
