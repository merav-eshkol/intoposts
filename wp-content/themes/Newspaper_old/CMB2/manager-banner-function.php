...
function yourprefix_register_demo_metabox() {
    ...
    $cmb_demo = new_cmb2_box( array(
        'id'            => $prefix . 'metabox',
        'title'         => esc_html__( 'Banner Configuration', 'cmb2' ),
        'object_types'  => array( 'manager-banner' ), // Post type
    ...
    $cmb_demo->add_field( array(
        'name' => esc_html__( 'Website URL right', 'cmb2' ),
    ...
    $cmb_demo->add_field( array(
        'name' => esc_html__( 'Image Top', 'cmb2' ),
        'desc' => esc_html__( 'Upload an image or enter a URL.', 'cmb2' ),
        'id'   => $prefix . 'image_2',
        'type' => 'file',
    ) );
